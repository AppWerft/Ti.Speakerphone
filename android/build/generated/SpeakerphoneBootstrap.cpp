...
static titanium::bindings::BindEntry SpeakerphoneBinding = {
	"ti.speakerphone",
	Speakerphone_init,
	Speakerphone_dispose
};

// Main module entry point
extern "C" JNIEXPORT void JNICALL
Java_ti_speakerphone_SpeakerphoneBootstrap_nativeBootstrap
	(JNIEnv *env, jobject self)
{
	titanium::KrollBindings::addExternalBinding("ti.speakerphone", &SpeakerphoneBinding);
	titanium::KrollBindings::addExternalLookup(&(::SpeakerphoneBindings::lookupGeneratedInit));
}
